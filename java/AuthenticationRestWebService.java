...
public class AuthenticationRestWebService extends RestWebService {
	...
	public Response authenticate(
		...
		try {
			...
			if (!password.isEmpty()){
				System.out.println("Dummy authentication for docker. If you read this in production is because a big error somewhere");						
				System.out.println(login + " is authenticated");						
				roles.add("Manager");
				roles.add("User");
			}
			else{
